  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#JiraLight_svg__paint0_linear_1206_689)"
      />
      <path
        d="M15.065 11.992L12 15.056a5.148 5.148 0 010 7.283l6.706-6.706-3.64-3.641z"
        fill="url(#JiraLight_svg__paint1_linear_1206_689)"
      />
      <defs>
        <linearGradient
          id="JiraLight_svg__paint0_linear_1206_689"
          x1={10.686}
          y1={6.619}
          x2={7.185}
          y2={10.118}
        ...
        <linearGradient
          id="JiraLight_svg__paint1_linear_1206_689"
          x1={13.351}
          y1={17.347}
          x2={16.845}
          y2={13.854}
...
const ForwardRef = React.forwardRef(SvgJiraLight);
