  ...
  return (
    ...
    >
      <path
        ...
        fill="#fff"
      />
      <path d="M12 20.36l3.683-10.68H8.319L12 20.36z" fill="#fff" />
      <path d="M12 20.36L8.316 9.68H3.162L12 20.36z" fill="#F1F6FA" />
      <path
      ...
      <path
        ...
        fill="#fff"
      />
      <path d="M12 20.36l3.683-10.68h5.163L12 20.36z" fill="#F1F6FA" />
      <path
...
const ForwardRef = React.forwardRef(SvgGitlabDark);
